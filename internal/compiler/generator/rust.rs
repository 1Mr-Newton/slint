    ...
    quote!(
        ...
        impl #public_component_id {
            pub fn new() -> ::core::result::Result<Self, slint::PlatformError> {
                ...
                sp::WindowInner::from_pub(inner.globals.get().unwrap().window_adapter_ref()?.window()).ensure_tree_instantiated();
...
fn generate_repeater_push_code(
    ...
    if llr::has_inner_repeaters(row_child_templates) {
        ...
        let inner_ensure_and_len = build_inner_ensure_and_len(templates, &row_inner_component_id);
